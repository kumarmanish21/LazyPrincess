...
DATABASE_NAME = environ.get('DATABASE_NAME', "Kumar_Manis")
...
# Others
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Requested_Zone') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Requested_Zone')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Movies Adda™](https://t.me/Requested_Zone)</b>⚡\n\n📂<b>File Name:</b> ⪧ {file_caption} \n <b>Size: </b>{file_size}\n\n❤")
...
LAZY_MODE = bool(environ.get("Requested_Zone")) #make it true to enable file renaming feature in bot

# Requested Content template variables --- 
ADMIN_USRNM = environ.get('ADMIN_USRNM','kumar_Manis') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','Requested_Zone') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','Requested_Zone') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','kumar_Manis')  # WITHOUT @ [  add only handle - don't add full url  ] 
...
DOWNLOAD_TEXT_URL = "https://t.me/Requested_Zone"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/Requested_Zone"
